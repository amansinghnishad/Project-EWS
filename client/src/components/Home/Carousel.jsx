  ...
  return (
    ...
    >
      <AnimatePresence initial={false} custom={direction}>
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(circle at center, rgba(0,0,0,0) 50%, rgba(0,0,0,0.8) 100%), linear-gradient(to top, rgba(0,0,0,0.7) 0%, rgba(0,0,0,0) 40%)",
            }}
          ></div>
      ...
      <button
        type="button"
        onClick={() => paginate(-1)}
        className="absolute left-2 top-1/2 -translate-y-1/2 z-10 w-9 h-9 rounded-full flex items-center justify-center"
      ...
      <button
        type="button"
        onClick={() => paginate(1)}
        className="absolute right-2 top-1/2 -translate-y-1/2 z-10 w-9 h-9 rounded-full flex items-center justify-center"
